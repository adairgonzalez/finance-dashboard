...
${accounts.map((a) => `- ${a.name} (****${a.last4}): Balance $${a.currentBalance.toFixed(2)} / $${a.creditLimit.toFixed(2)} limit, APR ${(a.apr * 100).toFixed(1)}%, Min payment $${a.minimumPayment.toFixed(2)}, Due ${a.paymentDueDate}`).join("\n")}

SUMMARY:
- Total debt: $${totalDebt.toFixed(2)}
- Total credit limit: $${totalCredit.toFixed(2)}
- Overall utilization: ${((totalDebt / totalCredit) * 100).toFixed(1)}%
